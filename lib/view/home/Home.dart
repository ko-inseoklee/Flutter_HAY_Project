...
import 'package:hay_project/view/profile/ProfileMainPage.dart';
  ...
  List<BottomNavigationBarItem> _bottomNavigationBarItems() {
    return [
      new BottomNavigationBarItem(
          icon: Image.asset("image/BNBIcons/CommunicationIcon.png",
              color: _pageIndex == 0
                  ? Colors.white
                  : Colors.white.withOpacity(0.6)),
          label: "대화"),
      new BottomNavigationBarItem(
          icon: Image.asset("image/BNBIcons/GameIcon.png",
              color: _pageIndex == 1
                  ? Colors.white
                  : Colors.white.withOpacity(0.6)),
          label: "게임"),
      new BottomNavigationBarItem(
        icon: Image.asset("image/BNBIcons/TestIcon.png",
            color:
                _pageIndex == 2 ? Colors.white : Colors.white.withOpacity(0.6)),
        label: "심리테스트",
      ),
      new BottomNavigationBarItem(
          icon: Image.asset("image/BNBIcons/ProfileIcon.png",
              color: _pageIndex == 3
                  ? Colors.white
                  : Colors.white.withOpacity(0.6)),
          label: "마이페이지"),
