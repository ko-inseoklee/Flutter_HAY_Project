...
class CommunicationQuestion extends StatefulWidget {
  final String communicationTitle;
   CommunicationQuestion({Key? key,required this.communicationTitle}) : super(key: key);
...
class _CommunicationQuestionState extends State<CommunicationQuestion> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        centerTitle: true,
        title: Text(widget.communicationTitle, style: TextStyle(color: Colors.white),),
          ...
          children: [
                ...
                children: [
                  Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      image: DecorationImage(image: AssetImage("image/CommunicationIcons/ComImage.png")),
                    ),
                  ),
                  Container(
                    width: 270,
                        ...
                        if(snapshot.connectionState == ConnectionState.none){
                          ...
                          return Padding(
                            padding: EdgeInsets.symmetric(horizontal: 16.0),
                              child: Text(question!,style: TextStyle(fontSize: 16.0,fontWeight: FontWeight.w600),));
                        }
                      },
                    ),
                  )
            ...
            Container(
              ...
              child: FlatButton(
                ...
                onPressed: () async {
                  question = await getCommunicationTopic(widget.communicationTitle);
                  setState(() {
                  });
                },
  ...
  Future<String> getCommunicationTopic(String category) async{
    Response response = await Dio().get("$serverUrl/communication/$category/random");
